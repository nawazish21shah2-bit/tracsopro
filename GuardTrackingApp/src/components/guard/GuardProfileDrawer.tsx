...
export const GuardProfileDrawer: React.FC<GuardProfileDrawerProps> = ({
  ...
  const menuOptions: MenuOption[] = [
    ...
    },
    {
      id: 'pastJobs',
      title: 'Past Jobs',
      subtitle: 'View completed assignments',
    ...
    },
    {
      ...
      subtitle: 'View your assigned locations',
    ...
    <View style={styles.profileHeader}>
      <View style={styles.avatarContainer}>
        <View style={styles.avatar}>
          <User width={40} height={40} color="#1C6CA9" />
        </View>
  ...
  const renderStatsSection = () => (
    <View style={styles.statsSection}>
      ...
      <View style={styles.statDivider} />
      <View style={styles.statItem}>
        <MapPin width={18} height={18} color="#6366F1" />
