...
const ClientOTPScreen: React.FC = () => {
  const navigation = useNavigation<ClientOTPScreenNavigationProp>();
  const route = useRoute<ClientOTPScreenRouteProp>();
...
export default ClientOTPScreen;
