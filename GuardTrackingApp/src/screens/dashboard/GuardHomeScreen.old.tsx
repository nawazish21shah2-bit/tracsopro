// Guard Dashboard Home Screen - Updated to match Figma designs
...
import { AppScreen, AppStatCard, AppCard } from '../../components/ui/AppComponents';
  ...
  const renderHeader = () => (
    <View style={styles.header}>
      ...
      <View style={styles.logoContainer}>
        <Image source={Logo} style={styles.logoImage as any} resizeMode="contain" />
      </View>
    ...
    <View style={styles.shiftSection}>
      ...
      <AppCard style={styles.shiftCard}>
        ...
        <TouchableOpacity style={styles.checkInButton} onPress={handleCheckIn}>
          <CheckInIcon size={24} color={COLORS.textInverse} style={styles.checkInIcon} />
        ...
        <View style={styles.actionButtons}>
          <TouchableOpacity style={styles.incidentButton} onPress={handleIncidentReport}>
            <IncidentIcon size={20} color={COLORS.textInverse} style={styles.incidentIcon} />
          ...
          <TouchableOpacity style={styles.emergencyButton} onPress={handleEmergencyAlert}>
            <EmergencyIcon size={20} color={COLORS.textInverse} style={styles.emergencyIcon} />
